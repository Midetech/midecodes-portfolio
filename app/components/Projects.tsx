    ...
    >
      ...
      <div className="flex lg:gap-[21px] gap-y-[21px] flex-wrap">
        <a target="_blank" href="https://mygift.myserviceagent.net/">
          <div className="lg:w-[538px] lg:h-[538px] lg:bg-[#C3D5E6] rounded-[15px] lg:px-20 px-10 lg:pt-[53px] pt-10 overflow-hidden relative">
            <img src="/images/mygift.png" alt="mygift" />
            <BorderBeam size={250} duration={12} delay={9} />
          </div>
        </a>
        <a target="_blank" href="https://purplesale.finance/">
          <div className="lg:w-[769px] lg:h-[538px] lg:bg-[#FFA3B0] rounded-[15px] lg:px-20 px-10  lg:pt-[53px] pt-10 overflow-hidden relative ">
            <img
        ...
        <a target="_blank" href="https://mygift.myserviceagent.net/">
          <div className="lg:w-[769px] lg:h-[538px] lg:bg-[#FEDB16] rounded-[15px]  lg:px-20 px-10 lg:pt-[53px] pt-10 overflow-hidden relative">
            <img src="/images/alienchain.png" alt="mygift" />
            <BorderBeam size={250} duration={12} delay={9} />
          </div>
        </a>
        <a target="_blank" href="https://myserviceagent.net/">
          <div className="lg:w-[538px] lg:h-[538px] lg:bg-[#EB2931] rounded-[15px] lg:px-20 px-10 lg:pt-[53px] pt-10 overflow-hidden relative">
