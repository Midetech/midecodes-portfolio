        ...
        <BoxReveal boxColor={"#5046e6"} duration={0.5}>
          <div className="lg:w-[860px] space-y-6 self-start">
            <p className="text-black dark:text-white font-serif text-[16px] font-[300] ">
              <span className="font-bold">Sunday Olomitutu</span>, passionate
              Frontend Developer adept in all stages of advanced web
              ...
              HTML, CSS, JavaScript, React, Bootstrap, Git & GitHub, Pivotal
              Tracker, Trello.
            </p>
            <p className="text-black dark:text-white font-serif text-[16px] font-[300] ">
              Able to effectively selfmanage during independent projects, as
              well as collaborate in a team setting. Ability to work remotely
              and onsite. Great Team player and Team Lead as the case may be.
            </p>
          </div>
        </BoxReveal>
